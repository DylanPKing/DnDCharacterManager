...
public class Queries {
    ...
    String addArmour(DnDCharacterDTO DnDCharacterDTO) {
        String query = "INSERT INTO armour (id, name, disadvantage, baseArmour)" +
                " VALUES " + DnDCharacterDTO.getArmourId() + DnDCharacterDTO.getArmourName()
                + DnDCharacterDTO.isDisadvantage() + DnDCharacterDTO.getBaseArmour();
        return query;
    }

    String addWeapon(DnDCharacterDTO DnDCharacterDTO) {
        String query = "INSERT INTO weapon (id, weight, properties, damageDie, damageType)" +
                " VALUES " + DnDCharacterDTO.getWeaponId() + DnDCharacterDTO.getWeaponWeight()
                + DnDCharacterDTO.getProperties() + DnDCharacterDTO.getDamageDie()
                + DnDCharacterDTO.getDamageType();
        return query;
    }
